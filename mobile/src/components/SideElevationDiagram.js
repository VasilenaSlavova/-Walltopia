  ...
  return (
    <View style={st.component}>
      ...
      <Svg width="100%" height="100%" viewBox={`0 0 ${W} ${H}`}>
        ...
        {(() => { const v=L.factored(baseHorizontal.rLL??0,"LL",state,unitMeta); return <G>{forceArrow(v<0?265:188,v<0?188:265,470,v<0)}<SvgText x="226" y="494" textAnchor="middle" fill={v<0?"#172d63":C.red} fontSize="8" fontWeight="700">{`RX0 = ${fmt(baseHorizontal.rLL)} ${unitMeta.force}`}</SvgText></G>; })()}
